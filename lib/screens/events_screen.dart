...
class EventsScreen extends StatelessWidget {
  ...
  static final List<Map<String, dynamic>> _events = [
    ...
    },
    {
      ...
      'videos': ['https://www.youtube.com/watch?v=U_P23SqJaDc'],
    },
    {
      ...
      'videos': ['https://www.youtube.com/watch?v=mJeNghZXtMo'],
    },
    {
    ...
    },
    {
      ...
      'videos': ['https://www.youtube.com/watch?v=c9Wg6Cb_YlU'],
    },
  ];
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  _DetailRow(Icons.calendar_today, 'Date', event['date'] as String),
                  const Divider(height: 20),
                  _DetailRow(Icons.access_time, 'Time', event['time'] as String),
                  const Divider(height: 20),
                  _DetailRow(
                      Icons.info_outline, 'Description', event['desc'] as String),
                ],
              ),
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  // Navigate to registration form (merges part2 flow)
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) =>
